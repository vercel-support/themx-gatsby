...
export default function FeaturedPost({ className }) {
  ...
  const featuredImageSources = [
    featuredImage.xs.childImageSharp.fluid,
    {
      ...featuredImage.xs.childImageSharp.fluid,
      media: `(max-width: 575px)`,
    },

    featuredImage.sm.childImageSharp.fluid,
    {
      ...featuredImage.sm.childImageSharp.fluid,
      media: `(max-width: 767px)`,
    },

    featuredImage.md.childImageSharp.fluid,
    {
      ...featuredImage.md.childImageSharp.fluid,
      media: `(max-width: 991px)`,
    },

    featuredImage.lg.childImageSharp.fluid,
    {
      ...featuredImage.lg.childImageSharp.fluid,
      media: `(max-width: 1199px)`,
    },

    featuredImage.xl.childImageSharp.fluid,
    {
      ...featuredImage.xl.childImageSharp.fluid,
      media: `(max-width:1919 px)`,
    },

    featuredImage.ret.childImageSharp.fluid,
    {
      ...featuredImage.ret.childImageSharp.fluid,
