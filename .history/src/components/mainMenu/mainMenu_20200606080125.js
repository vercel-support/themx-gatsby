...
const MAIN_MENU_QUERY = graphql`
  ...
  query GET_MENU_ITEMS {
    ...
    WpMenuItems(where: { location: MENU_1 }) {
      nodes {
        ...MenuFields
      }
    }
      ...
      render={({
        ...
        return (
          <nav className="container d-flex align-items-center">
            ...
            <ul
              className="m-0 justify-content-around flex-fill align-items-center px-80 d-none d-md-flex collapse navbar-collapse"
            ...
            <div
              className="hamburger-button dropdown-toggler ml-auto bg-primary rounded"
            ...
            >
              <div className="hamburger d-md-none"></div>
            </div>
          </nav>
        )
      }}
