...
const renderMenuItem = (item, generalSettingsUrl, generalSettingsTitle) => {
  ...
  return (
    <li className="mb-0 py-16 menu-item" key={item.id}>
      <Link to={createLocalLink(relativePath)} className="nav-link">
        {item.label}
      </Link>
  ...
  return (
    <StaticQuery
      ...
      render={({
        ...
        return (
          // <nav className="container d-flex align-items-center navbar navbar-expand-lg">
          //   <h1>
          //     <Link to="/">
          //       <svg
          //         // width="109"
          ...
          //     <ul className="m-0 justify-content-around flex-fill align-items-center px-80 d-none d-md-flex list-unstyled navbar-nav">
          //       {menu.map(item =>
          //         renderMenuItem(item, generalSettingsUrl, generalSettingsTitle)
          //       )}
          //     </ul>
          //     <div
          //       className="hamburger-button navbar-toggler ml-auto bg-primary rounded d-md-none"
