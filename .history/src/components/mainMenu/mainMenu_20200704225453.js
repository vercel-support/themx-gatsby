          ...
          <Container>
            <Navbar expand="lg" className="d-flex">
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Form inline className="search mb-0 position-relative">
                  <FormControl
                    type="text"
                    placeholder="Zoek..."
                    className="mr-sm-2 search-field position-absolute border-0"
                  />
                  <Button className="search-button px-16 bg-transparent border-0">
