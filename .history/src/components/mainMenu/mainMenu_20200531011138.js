      ...
      render={({
        ...
        return (
          <nav className="container d-flex align-items-center">
            ...
            <ul className="navbar nav m-0 justify-content-around flex-fill align-items-center px-80 d-none d-md-flex">
              {menu.map(item =>
                renderMenuItem(item, generalSettingsUrl, generalSettingsTitle)
              )}
            </ul>
            <div className="hamburger-button dropdown-toggler ml-auto bg-primary rounded">
