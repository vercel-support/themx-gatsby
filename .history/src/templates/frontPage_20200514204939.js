...
const FrontPage = props => {
  ...
  //   edges.featuredImage.portrait.childImageSharp.fluid,
  //   {
  //     ...edges.node.featuredImage.portrait.childImageSharp.fluid,
  //     media: `(max-width: 640px)`,
  //   },
  //   edges.featuredImage.landscape.childImageSharp.fixed,
  //   {
  //     ...edges.node.featuredImage.landscape.childImageSharp.fixed,
  //     media: `(min-width: 640px)`,
  //   },
  // ]
  return (
        ...
        {edges.map(edge => {
          ...
          return (
            <Link to={uri} className="title-card position-relative rounded">
              ...
              />
              {console.log(
                posts.edges[0].node.featuredImage.portrait.childImageSharp.fluid
              )}
              {/* {featuredImage.portrait && (
                <Img
                  fluid={imageSourcesSixPosts}
                  alt={title}
