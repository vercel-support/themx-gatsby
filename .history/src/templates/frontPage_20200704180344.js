      ...
      <section className="container py-60">
        <div className="d-flex justify-content-center justify-content-md-between flex-wrap">
          ...
          <Link to={oceaniaCat.uri}>
			...
			<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"><defs><style>.cls-1{fill:#fff;}</style></defs><title>Untitled-1</title><path class="cls-1" d="M823.22,592.47H206.45c0-127.08,105.61-127.08,106.69-254.17H823.22Z" /></svg>
    </Layout>
  )
}
