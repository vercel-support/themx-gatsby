  ...
  return (
    <Layout>
      ...
      <div className="content-layout container">
        ...
        <section className="pt-100 d-flex align-items-center">
          <Typography type="body-m" component="h5" disableMargin className="">
            Geschreven door:{" "}
            <Link to={`/author/${author.slug}/`}>{author.name}</Link>
          </Typography>
          <a href={`https://instagram.com/${custominstagram}`} className="px-8">
            <FontAwesomeIcon icon={faInstagram} />
          </a>
          <a href={`https://twitter.com/${customtwitter}`} className="px-8">
            <FontAwesomeIcon icon={faTwitter} />
          </a>
          <a href={`https://facebook.com/${customfacebook}`} className="px-8">
            <FontAwesomeIcon icon={faFacebook} />
          </a>
          <a href={`https://pinterest.com/${custompinterest}`} className="px-8">
