...
const FrontPage = props => {
  ...
  return (
    <Layout>
      ...
      <section className="container grid grid-3x2 pb-60">
        {edges.map(edge => {
          ...
          const imageSourcesSixPosts = ({ data }) => [
            data.featuredImage.xsSm.childImageSharp.fixed,
            {
              ...data.featuredImage.mdLgXl.childImageSharp.fixed,
              media: `(min-width: 768px)`,
            },
          ]
          return (
            ...
            >
              ...
              {console.log(imageSourcesSixPosts)}
            </Link>
          )
        })}
      </section>
      ...
      {/* <FeaturedPost /> */}
      {console.log(europePng.imageFile)}
