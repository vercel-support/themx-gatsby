      ...
      <section className="container">
        <div className="d-flex">
          ...
          <Link to={africaCat.uri}>
            ...
            <Img fixed={africaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={northAmericaCat.uri}>
            <Typography component="h3">{northAmericaCat.name}</Typography>
            <Img fixed={northAmericaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={southAmericaCat.uri}>
            <Typography component="h3">{southAmericaCat.name}</Typography>
            <Img fixed={southAmericaPng.imageFile.childImageSharp.fixed} />
          </Link>
        </div>
      </section>
    </Layout>
