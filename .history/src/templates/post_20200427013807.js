...
const Post = props => {
  ...
  const { title, author, categories, tags, content, hotelCards } = post
  return (
    <Layout>
      ...
      <section className="hotel-cards-wr">
        ...
        <a href={`${nHotel1Afflink}`} className="hotel-1">
          <h5>{hotelCards.nHotel1Naam}</h5>
          <img
            src={`${hotelCards.nHotel1Afbeelding}`}
            alt={`${hotelCards.hotel_cards_name_1}`}
          />
          <span>
        ...
        <a href={`${hotelCards.nHotel2Afflink}`} className="hotel-2">
          ...
          <img
            ...
            alt={`${hotelCards.hotel_cards_name_2}`}
          />
          <span>
