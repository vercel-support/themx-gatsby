...
const FrontPage = props => {
  ...
  return (
    <Layout>
      ...
      <PostCard
        arrayCard={posts.edges}
        titleCard={posts.edges.node.title}
        uriCard={posts.edges.node.uri}
        imageCard={posts.edges.node.featuredImage}
        categoriesCard={posts.edges.node.categories}
        idCard={posts.edges.node.id}
      />
