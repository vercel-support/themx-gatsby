    ...
    <Layout>
      ...
      <div className="content-layout container">
        ...
        <section className="pt-100 d-flex align-items-center">
          ...
          <a href={`https://instagram.com/${custominstagram}`} className="px-4">
            <FontAwesomeIcon icon={faInstagram} />
          </a>
          <a href={`https://twitter.com/${customtwitter}`} className="px-4">
            <FontAwesomeIcon icon={faTwitter} />
          </a>
          <a href={`https://facebook.com/${customfacebook}`} className="px-4">
            <FontAwesomeIcon icon={faFacebook} />
          </a>
          <a href={`https://pinterest.com/${custompinterest}`} className="px-4">
