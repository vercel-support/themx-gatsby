    ...
    <Layout>
      ...
      <div className="content-layout container">
        ...
        <section className="pt-100">
          <Typography type="body-m" component="h5">
            Geschreven door:{" "}
            <Link to={`/author/${author.slug}/`}>{author.name}</Link>
          </Typography>
          <FontAwesomeIcon icon={author.faInstagram} />
          <FontAwesomeIcon icon={author.faTwitter} />
          <FontAwesomeIcon icon={author.faFacebook} />
          <FontAwesomeIcon icon={author.faPinterest} />
        </section>
