...
const FrontPage = props => {
  ...
  //   aboutUs.featuredImage.aboutUsImage.childImageSharp.fluid,
  //   // {
  //   //   ...aboutUs.featuredImage.aboutUsImage.childImageSharp.fluid,
  //   //   media: `(min-width: 768px)`,
  //   // },
  ...
  return (
    <Layout>
      <SEO
        title={frontPage.featuredImage.imageFile.childImageSharp.fluid.title}
      />
      ...
      <section className="container-fluid py-60">
        <div className="grid about-us">
          ...
          />
          <Img
            fluid={aboutUs.featuredImage.aboutUsImage.childImageSharp.fluid}
