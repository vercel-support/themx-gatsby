      ...
      <section className="container">
        <div className="d-flex">
          <Link to={europeCat.uri}>
            ...
            <Img fluid={europePng.imageFile.childImageSharp.fluid} />
          </Link>
          <Link to={asiaCat.uri}>
            <Typography component="h3">{asiaCat.name}</Typography>
            <Img fluid={asiaPng.imageFile.childImageSharp.fluid} />
          </Link>
          <Link to={oceaniaCat.uri}>
            <Typography component="h3">{oceaniaCat.name}</Typography>
            <Img fluid={oceaniaPng.imageFile.childImageSharp.fluid} />
          </Link>
          <Link to={africaCat.uri}>
            <Typography component="h3">{africaCat.name}</Typography>
            <Img fluid={africaPng.imageFile.childImageSharp.fluid} />
          </Link>
          ...
          <Link to={southAmericaCat.uri}>
            ...
            <Img fluid={southAmericaPng.imageFile.childImageSharp.fluid} />
          </Link>
        </div>
      </section>
    </Layout>
