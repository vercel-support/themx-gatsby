    ...
    <Layout>
      ...
      <div className="content-layout container">
        ...
        <section className="pt-100 d-flex align-items-center pb-8">
          ...
          {console.log(author.customtwitter)}
          {/* {customavatar && (
            <Img
          ...
          <a
            href={`https://facebook.com/${author.customfacebook}`}
            className="px-4 text-gray-600"
          >
            <FontAwesomeIcon icon={faFacebookSquare} />
          </a>
          <a
            href={`https://twitter.com/${author.customtwitter}`}
            className="px-4 text-gray-600"
          >
            <FontAwesomeIcon icon={faTwitter} />
          </a>
          <a
            href={`https://instagram.com/${author.custominstagram}`}
            className="px-4 text-gray-600"
          >
            <FontAwesomeIcon icon={faInstagram} />
          </a>
          <a
            href={`https://pinterest.com/${author.custompinterest}`}
            className="px-4 text-gray-600"
          >
