        ...
        <section className="hotel-cards-wr">
          ...
          <div class="grid">
            <a
              ...
              className="hotel-1 position-relative"
            >
              <h5 className="position-absolute">{hotelCards.nHotel1Naam}</h5>
              <span className="position-absolute bottom-16">
            ...
            <a
              ...
              className="hotel-2 position-relative"
            >
              <h5 className="position-absolute">{hotelCards.nHotel2Naam}</h5>
