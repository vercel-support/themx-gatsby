      ...
      <section className="container py-60">
        <div className="d-flex justify-content-between">
          <Link to={europeCat.uri}>
            ...
            <Img fixed={props.europePng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={asiaCat.uri}>
            <Typography component="h3" className="text-center">
              {asiaCat.name}
            </Typography>
            <Img fixed={props.asiaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={oceaniaCat.uri}>
            <Typography component="h3" className="text-center">
              {oceaniaCat.name}
            </Typography>
            <Img fixed={props.oceaniaPng.imageFile.childImageSharp.fixed} />
          </Link>
        </div>
      </section>
    </Layout>
