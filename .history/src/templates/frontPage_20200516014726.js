    ...
    wpgraphql {
      page(id: $id) {
        ...
        featuredImage {
          ...
          sm: imageFile {
            childImageSharp {
              fluid(maxWidth: 767, maxHeight: 767) {
                ...GatsbyImageSharpFluid_withWebp
              }
            }
          }
        ...
        featuredImage {
          ...
          md: imageFile {
            childImageSharp {
              fluid(maxWidth: 991, maxHeight: 991) {
                ...GatsbyImageSharpFluid_withWebp
              }
            }
          }
        ...
        featuredImage {
          ...
          lg: imageFile {
            childImageSharp {
              fluid(maxWidth: 1199, maxHeight: 512) {
                ...GatsbyImageSharpFluid_withWebp
              }
            }
          }
        ...
        featuredImage {
          ...
          xl: imageFile {
            childImageSharp {
              fluid(maxWidth: 1920, maxHeight: 512) {
                ...GatsbyImageSharpFluid_withWebp
              }
            }
          }
        ...
        featuredImage {
          ...
          ret: imageFile {
            childImageSharp {
              fluid(maxWidth: 2560, maxHeight: 512) {
                ...GatsbyImageSharpFluid_withWebp
              }
            }
          }
