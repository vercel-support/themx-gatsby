...
export const firstCategoryBlock = {
  firstCategoryBlock: "Budget",
}

export const frontPageQuery = graphql`
  query GET_FRONTPAGE($id: ID!, $firstCategoryBlock: String) {
    wpgraphql {
      page(id: $id) {
      ...
      posts(first: 3, where: { categoryName: $firstCategoryBlock }) {
        nodes {
          title
