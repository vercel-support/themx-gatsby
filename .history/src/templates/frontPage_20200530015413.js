    ...
    <Layout>
      ...
      <section className="container">
        <div className="d-flex">
          <Link to={europeCat.uri} className="d-flex flex-column">
            <Typography component="h3">{europeCat.name}</Typography>
            <Img fluid={europePng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={asiaCat.uri}>
            <Typography component="h3">{asiaCat.name}</Typography>
            <Img fluid={asiaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={oceaniaCat.uri}>
            <Typography component="h3">{oceaniaCat.name}</Typography>
            <Img fluid={oceaniaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={africaCat.uri}>
            <Typography component="h3">{africaCat.name}</Typography>
            <Img fluid={africaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={northAmericaCat.uri}>
            <Typography component="h3">{northAmericaCat.name}</Typography>
            <Img fluid={northAmericaPng.imageFile.childImageSharp.fixed} />
          </Link>
          <Link to={southAmericaCat.uri}>
            <Typography component="h3">{southAmericaCat.name}</Typography>
            <Img fluid={southAmericaPng.imageFile.childImageSharp.fixed} />
          </Link>
        </div>
      </section>
    </Layout>
...
export const frontPageQuery = graphql`
  query GET_FRONTPAGE($id: ID!) {
    wpgraphql {
      ...
      northAmericaCat: category(idType: NAME, id: "Noord-Amerika") {
        uri
        name
      }
