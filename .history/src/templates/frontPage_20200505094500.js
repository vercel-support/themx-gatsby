    ...
    <Layout>
      ...
      <div className="container grid">
        {edges.map(edge => {
          ...
          return (
            <Link to={uri} className="title-card position-relative rounded-lg">
              <span className="title-card-category position-absolute rounded bg-primary">
              ...
              {featuredImage.imageFile && (
                <Img
                  ...
                  alt={title}
                  className="title-card-image rounded-lg"
                />
              )}
            </Link>
          )
