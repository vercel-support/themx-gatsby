...
const FrontPage = (props) => {
  ...
  const imageSourcesHeader = [
    frontPage.featuredImage.imageFile &&
      ...
      {
        ...frontPage.featuredImage.landscape
          .childImageSharp.fluid,
  ...
  const imageSourcesAboutUs = [
    aboutUs.featuredImage.portrait &&
      (aboutUs.featuredImage.landscape
        .childImageSharp.fluid,
      {
        ...aboutUs.featuredImage.landscape
          .childImageSharp.fluid,
  ...
  return (
    <Layout>
      ...
      {frontPage.featuredImage.imageFile && (
        <Img
          fluid={imageSourcesHeader}
          alt={frontPage.title}
        />
      )}
      <PageDivider component='h2'>
      ...
      {/* <svg with="0" height="0">
        <defs>
          <clipPath id="aboutUsShape">
            <path
              fill="#fff"
              d="M823.22,592.47H206.45c0-127.08,105.61-127.08,106.69-254.17H823.22Z"
            />
          </clipPath>
        </defs>
      </svg> */}
