      ...
      <div className="container grid grid-height-300">
        {edges.map(edge => {
          ...
          const imageSourcesSixPosts = [
            featuredImage.xsSm.childImageSharp.resize,
            {
              ...featuredImage.xsSm.childImageSharp.resize,
              media: `(max-width: 767px)`,
            },
            featuredImage.mdLgXl.childImageSharp.resize,
            {
              ...featuredImage.mdLgXl.childImageSharp.resize,
              media: `(min-width: 768px)`,
            },
        ...
        edges {
          node {
            ...
            featuredImage {
              ...
              xsSm: imageFile {
                childImageSharp {
                  resize(width: 540, height: 300, cropFocus: CENTER) {
                    ...GatsbyImageSharpResize_withWebp
                  }
                }
              }
            }
            featuredImage {
              ...
              mdLgXl: imageFile {
                childImageSharp {
                  resize(width: 472, height: 300, cropFocus: CENTER) {
                    ...GatsbyImageSharpResize_withWebp
                  }
                }
              }
