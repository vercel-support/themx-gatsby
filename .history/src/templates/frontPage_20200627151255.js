...
const FrontPage = props => {
  ...
  return (
    <Layout>
      ...
      {console.log(frontPage.featuredImage.imageFile)}
      {frontPage.featuredImage.imageFile && (
      ...
      <section className="container py-60">
        <div className="d-flex justify-content-between">
          <Link to={europeCat.uri}>
            ...
            {console.log(europeCat.countryMeta.imageFile)}
            {europeCat.countryMeta.imageFile && (
              <Img
                fixed={europeCat.countryMeta.imageFile.childImageSharp.fixed}
              />
            )}
          </Link>
          <Link to={asiaCat.uri}>
