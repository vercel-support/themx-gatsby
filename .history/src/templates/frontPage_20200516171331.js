...
const FrontPage = props => {
  ...
  const imageSourcesHeader = [
    ...
    page.featuredImage.xsSm.childImageSharp.fluid,
    // {
    //   ...page.featuredImage.sm.childImageSharp.fluid,
    //   media: `(max-width: 767px)`,
    // },

    page.featuredImage.mdLgXlRet.childImageSharp.fluid,
    // {
          ...
          mdLgXlRet: imageFile {
            childImageSharp {
              fluid(
                maxWidth: 991
                maxHeight: 512
                srcSetBreakpoints: [991, 1199, 1919]
              ) {
                ...GatsbyImageSharpFluid_withWebp
              }
            }
